    ...
    return (
        <>
            ...
            <Form onSubmit={handleSubmit} method='POST'>
                ...
                <br />
                <Form.Group>
                    <Form.Label>Password Confirmation:</Form.Label><Form.Control type="password" value={password2} id="password2" name="password2" onChange={e => setPassword2(e.target.value)} />
                </Form.Group>
                <br />
